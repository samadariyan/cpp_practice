...
export void tinker_with_shared_pointers() {
    ...
    // Shared pointers basics
    {
        ...
        *int_ptr_1 = 40; // Use the pointer to assign
        ...
        fmt::println("The pointed to value is (through int_ptr2): {}",
                     *int_ptr_2);
        *int_ptr_2 = 70;
        fmt::println("The pointed to value is (through int_ptr2): {}",
                     *int_ptr_2);
        ...
        fmt::println("The pointed to value is (through int_ptr5): {}",
                     *int_ptr_5);
        *int_ptr_5 = 100;
        fmt::println("The pointed to value is (through int_ptr5): {}",
                     *int_ptr_5);
        ...
        int_ptr_raw = nullptr;
        fmt::println(
            "The value pointed to by int_ptr_raw is (through int_ptr_6): {}",
            *int_ptr_6);
