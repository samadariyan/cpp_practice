...
export void cstring_strcmp() {
    ...
    // order, Zero if lhs and rhs compare equal. and Positive value if lhs
    // appears after rhs in lexicographical order.
    fmt::println("");
    ...
    fmt::println("std::strcmp ({} ,{} ) : {}", string_data1, string_data2,
                 std::strcmp(string_data1, string_data2));

    fmt::println("std::strcmp ({}, {}): {}", string_data3, string_data4,
                 std::strcmp(string_data3, string_data4));

    string_data1 = "Alabama";
    string_data2 = "Alabamb";

    // string_data3 = "Alabama"; // Error: can't directly assign to a static
    // array string_data4 = "Alabamb";
...
export void cstring_strncmp() {
    ...
    // lhs appears before rhs in lexicographical order. Zero if lhs and rhs
    // compare equal, or if count is zero. Positive value if lhs appears after
    // rhs in lexicographical order. Print out the comparison
