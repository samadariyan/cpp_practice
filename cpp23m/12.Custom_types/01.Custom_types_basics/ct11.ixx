/*
    . Exploring the use of the explicit keyword to prevent implicit conversions
   from constructors. . We don't want the compiler to convert a uint32_t to a
   Pixel object. . You can do that : . using the explicit keyword as shown below
    ...
    . You can explicitly allow implicit conversions by using the explicit(false)
   keyword.
*/
module;
