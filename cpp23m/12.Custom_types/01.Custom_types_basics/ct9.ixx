/*
        ...
        . This is a pattern you'll see everytime your class does some kind of
   resource management. . Try to stay away from raw pointers in modern C++ code
   though. In most cases, smart pointers are the way to go. . In this case for
   example, we don't have to worry about releasing the memory allocated by the
   smart pointer. It will be automatically released when the object goes out of
   scope.
*/
module;
...
Pixel::Pixel(const Pixel& source)
    : m_color{source.m_color}, m_pos{new Position{*source.m_pos}},
