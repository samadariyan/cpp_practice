...
// Area computation
//  Area of a square
export double area(double side) { return side * side; }

// Area of a rectangle
export double area(double length, double width) { return length * width; }
...
// Chat bot
//  Default response
export void respond() { fmt::print("I'm here to help! What do you need?\n"); }
