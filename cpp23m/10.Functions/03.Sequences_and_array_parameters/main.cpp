...
//double sum(double *scores, size_t count)
{
    ...
    double score_sum{};
    fmt::println( "sizeof(scores)  : {}" , sizeof(scores) );    //Inside the
function the array decays to a pointer fmt::println( "sizeof(int*) : {}" ,
sizeof (int *) );
    //auto arr_size = std::size(scores);  // std::size doesn't work here because
...
int main() {
    ...
    */
    ...
    // Passing (seemingly) sized array function parameters
    /*
    double student_scores[]{ 10.0, 20.0, 30.0, 40.0, 50.0, 60.0 };// Less than 5
    parameters
    ...
    */
    ...
    /*
    double
    student_scores[]{ 10.0, 20.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 90.0,
    100.0};
