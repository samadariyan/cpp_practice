...
**Note:** Please carry out these challenges manually without using code generation tools like ChatGPT. Doing so will hurt your learning process and hinder your progress.
...
- Count and print how many uppercase letters, lowercase letters, digits, and punctuation marks the text contains
...
3. **Use Debugging**: Add print statements to understand program flow
4. **Follow Best Practices**: Use meaningful variable names and proper indentation
5. **Handle Edge Cases**: Consider empty strings, single characters, and special characters
