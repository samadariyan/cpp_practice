...
export void tinker_with_unique_pointers() {
...

    {
        ...
        std::unique_ptr<int> up_int4{p_int3};
        // Can also manage a previously allocated
        ...
        std::unique_ptr<int> up_int6{nullptr};
        // Can also initialize with nullptr
    ...
    // std::unique_ptr<int> up_int9 = up_int8; // Error.
    // This also does some kind of copy
    // More on this when we've learnt about operator overloading
    // std::unique_ptr<int> up_int10{up_int8}; // Error :
    ...
    {
        std::unique_ptr<int> up_int12 = std::move(up_int11);
        // Now up_int12 manages int11 and up_int11 points to nothing (nullptr)
        fmt::println("up_int12 pointing at address :{}",
