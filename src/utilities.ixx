...
export void access_and_modify() {
  ...
  std::string str1{"Hello world!"};
  std::println("First character of str1: {}", str1[0]);
  ...
  str1[0] = 'h';
  str1.at(7) = 'w';
  std::println("Modified str1: {}", str1);
}
...
export void appending_and_concatenation() {
  ...
  std::println("Concatenated str5: {}", str5);
}
...
export void substrings_and_finding() {
  ...
  std::println("Substring of str1: {}", subStr);
...
export void comparison() {
  ...
  if (str1.compare(str2) == 0) {
    std::println("str1 is equal to str2");
  } else {
    std::println("str1 is not equal to str2");
  }

  if (str1.compare(str2) > 0) {
    std::println("str1 is greater");
  } else {
    std::println("str2 is greater");
  }
}
...
export void length_capacity_clear() {
  ...
  std::string str1{"Hello world!"};
  std::println("Length of str1: {}", str1.length());
  std::println("Capacity of str1: {}", str1.capacity());

  // Iterating over a string
  // Using range-based for loop to iterate over a string
  std::print("Characters in str1: ");
  ...
  str1.clear();
  std::println("Cleared str1, new length: {}", str1.length());
}
...
export void declaration_and_initialization() {
  ...
  // Print the data out
  // std::println("Printing after changing the data: ");
  // for (size_t i{0}; i < array_size; ++i) {
  //   std::println("scores [{}] : {}", i, scores[i]);
  // }

  // Write data in a loop
  // std::println("Changing the data in a loop");
  // for (size_t i{0}; i < array_size; ++i) {
  //   scores[i] = i * 10;
  // }
  ...
  for (size_t i{0}; i < 5; ++i) {
    std::println("salaries [{}]: {}", i, salaries[i]);
  }
...
export void size_of_an_array() {
  ...
  std::println("sizeof(scores) : {}", sizeof(scores));       // 12
  std::println("sizeof(scores[0]) : {}", sizeof(scores[0])); // 4
  // std::println("count : {}", count);                         // 3
...
export void arrays_of_characters() {
  ...
  // The null terminator is there. GOOD
  ...
  // std::println("Data: {}", data); // fmt knows how to print arrays of
  // characters.
  ...
  std::println("sizeof(message1) : {}", sizeof(message1)); // 6

  // String literal
  char message4[]{"Hello"}; // The null terminator is auto filled in.
  std::println("message4 : {}", message4);
  std::println("sizeof(message4) : {}", sizeof(message4)); // 6
}
