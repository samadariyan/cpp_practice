...
export void pointers_arrays_relationship() {
  ...
  // The name of the array can be used as a pointer to the first element of the
  // array
  ...
  // scores = &number; // The array name is a pointer, but a special pointer
  // that kind of identifies
  //   the entire array. You'll get the error  : incompatible types in
  //   assignment
  //  of 'int*' to 'int[10]'
