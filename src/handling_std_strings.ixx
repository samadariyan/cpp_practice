...
export void std_string_concatenation() {
    ...
    */
    ...
    std::string str7{std::string{"Hello"} + " World"};//Turn one or both into a
    std::string
                                                    //object  and do
    theconcatenation fmt::println( "str5: {}",  str5 ); fmt::println( "str6:
    {}",  str6 ); fmt::println( "str7: {}", str7);

    using namespace std::string_literals; // necessary for the s suffix
                                        // This polutes the namespace.
    std::string str8 {"Hello"s + " World"};// Turn one or both into strings
    using the
                                //s suffix . the string_literals namespace has
    to be imported
                                //for this to work
