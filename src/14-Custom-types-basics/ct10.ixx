/*
    . Exploring constructor delegation
        ...
        . They should be the only member initializer in the list.
            ...
            . Variables not initialized by a delegated constructor, can't be
   added to the initializer list too. . The one parameter constructor delegates
   to the three parameter constructor. . The copy constructor delegates to the
   three parameter constructor. . This approach keeps your code DRY (Don't
